...
if($db_found){
      ...
      $sql = "SELECT * FROM Items, Musique WHERE categorie=2 AND id_musique=id_item";
      ...
      while($data = mysqli_fetch_assoc($result)){
        ...
        echo "<div class='Musique'><table class='table text-left'><tr><td>Nom de l'article:" .$data['nom_item']. '</td>';
        echo "<td>Description:" .$data['description_item']. '</td>';
        echo "<td>Quantite:" .$data['quantite']. '</td>';
        echo "<td>Prix:" .$data['prix_item']. '</td>';
        echo "<td>Auteur de la musique:" .$data['auteur']. '</td>';
        echo "<td>Annee de Parution:" .$data['annee']. '</td>';
        echo "<td>Genre:" .$data['type']. '</td>';
        echo "</div>";
       // end line
