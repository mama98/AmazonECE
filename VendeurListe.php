  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    if($cat==1){
      ...
      while($data1 = mysqli_fetch_assoc($result1)){
        unset($value);
        echo "<div class='Livres'><table class='table text-left'> <tr><td>Nom de l'article:" .$data1['nom_item']. '</td>';
        ...
        echo ' <button class="btn btn-danger btn-xs" type="submit" ><i class="fas fa-trash-alt"></i></button>';
        echo '</form></td>';
        echo "</tr></table></div>";
    ...
    if($cat==2){
      ...
      while($data2 = mysqli_fetch_assoc($result2)){
        unset($value);
        echo "<div class='Musique'><table class='table  text-left'> <tr><td>Nom de l'article:" .$data2['nom_item']. '</td>';
    ...
    if($cat==3){
      ...
      while($data3 = mysqli_fetch_assoc($result3)){
        ...
        echo "<table class='table text-left'> <tr><td>Nom de l'article:" .$data3['nom_item'].'</td>';
    ...
    if($cat==4){
      ...
      while($data4 = mysqli_fetch_assoc($result4)){
        unset($value);
        echo "<div class='Sports_Loisirs'>";
        echo"<table class='table text-left'><tr><td>Nom de l'article:" .$data4['nom_item'].'</td>';
        ...
        if($data4['typeSport']==""){
          ...
          echo "<td>Type de Sport:" .$data4['typeSport']. '</td>';
        }
        foreach ($p_array as $value) {
            echo "<td><img src=\"images_items/$value\" style=\"width: 160px; height: 160px;\"></td>";
        } 
    ...
    echo '</video>';
        ...
        echo "<BR><form><button class='btn btn-primary' formaction='VendeurMenu.php' type='submit' >Retour au menu</button></form>";
