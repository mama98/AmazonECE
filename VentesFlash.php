...
function afficher_item($data) {
    echo "<div><table class='table text-left'> <tr><td>Nom de l'article:" .$data['nom_item']. '</td>';
    echo "<td>Description:" .$data['description_item']. '</td>';
    echo "<td>Quantite:" .$data['quantite']. '</td>';
    echo "<td>Prix:" .$data['prix_item']. '</td>';
    echo "<td>Nombre de ventes:" . $data['nb_vendu'] . '</td>';
...
if($db_found){
  ...
  echo "<BR><form><button class='button' formaction='acceuil.html' type='submit' >Retour Accueil</button></form>";
