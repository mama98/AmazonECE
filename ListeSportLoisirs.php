...
if($db_found){
      ...
      $sql = "SELECT * FROM Items, Sports_Loisirs WHERE categorie=4 AND id_sportsLoisirs=id_item";
      ...
      while($data = mysqli_fetch_assoc($result)){
        ...
        echo "<div class='Sports_Loisirs'><table class='table text-left'><tr><td>Nom de l'article:" .$data['nom_item']. '</td>';
        echo "<td>Description:" .$data['description_item']. '</td>';
        echo "<td>Quantite:" .$data['quantite']. '</td>';
        echo "<td>Prix:" .$data['prix_item']. '</td>';

        if($data['typeSport']==""){
          echo "<td>Type de Loisirs:" .$data['typeLoisirs']. '</td>';
        } else {
          echo "<td>Type de Sport:" .$data['typeSport']. '</td>';
        }
        echo "</div>";
       // end line
