  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav mr-auto">
        <li class=""><a id="ventesflash" href="VentesFlash.php">Ventes flash</a></li>
...
if($db_found){
    ...
    foreach ($p_array as $value) {
      echo "<img src=\"images_items/$value\" style=\"width: 160px; height: 160px;\">"; }*/
       ...
       echo "<div class='Livres'><table class='table text-left'> <tr><td>Nom de l'article:" .$data['nom_item']. '</td>';
        echo "<td>Description:" .$data['description_item']. '</td>';
        echo "<td>Quantite:" .$data['quantite']. '</td>';
        echo "<td>Prix:" .$data['prix_item']. '</td>';
        echo "<td>Auteur du livre:" .$data['auteur']. '</td>';
        echo "<td>Annee de Parution:" .$data['annee']. '</td>';
        echo "<td>Edition du livre:" .$data['edition']. '</td>';
        foreach ($p_array as $value) {
    ...
    echo '<br>Quantité : <br>' ;
    echo '<form action="ajoutPanier.php" method="post"><input type="number" name="quantite" /><br></form>';
    ...
    if(!is_null($video))
      {  echo '<td><video width = "160" height="160" controls>';
        ...
        echo '</video></td>';}
        echo '<td>Quantité :</td>' ;
        echo '<td><form action="ajoutPanier.php?arg='.$id_item.'" method="post" enctype="multipart/form-data"></td>';
        echo '<td><input type="number" min="0" name="Quantite" /></td>' ;
        echo '<td><button class="btn btn-success btn-xs" type="submit" ><i class="fas fa-cart-plus"></i></button>';
        echo '</form></td>';
        echo "</tr></table></div>";
  
}
  echo "<BR><form><button class='button' formaction='acceuilAcheteur.php' type='submit' >Retour au menu</button></form>";
